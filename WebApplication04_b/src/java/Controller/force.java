 ...
 * @author Huy
 */
@WebServlet(name = "force", urlPatterns = {"/force"})
public class force extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if(txtUsername.equals("giahuy") && txtPassword.equals("12345678")){
           out.println("Login sucessful!");
           return;
       }else{
           out.println("Username or password valid!");
           return;
       }
    }
